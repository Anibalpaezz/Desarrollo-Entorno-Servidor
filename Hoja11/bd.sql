...
insert into noticias (Titulo, Texto, Categoria, Fecha, Imagen) values ('Apartamentos en el Puerto de Sta Maria', 'En la playa de Valdegrana, en primera linea de playa. Pisos reformados y completamente amueblados', 'Costas', '2007-02-06', 'imagenes/apartamento8.jpg');
...
insert into noticias (Titulo, Texto, Categoria, Fecha, Imagen) values ('Promocion en Costa Ballena', 'Con vistas al campo de golf, magnificas calidades, entorno ajardinado con piscina y servicio de vigilancia', 'Costas', '2007-02-09', 'imagenes/apartamento9.jpg');
